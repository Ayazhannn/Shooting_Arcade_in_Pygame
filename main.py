...
pygame.display.set_caption("Shooting Arcade")
...
load_image('duck_brown', 'images/duck_outline_brown.png')
load_image('duck_brown_target', 'images/duck_outline_target_brown.png')
...
def display_score():
    ...
    digit_x = images['score'].get_width() + images['colon'].get_width() + 10
...
class Duck(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        #keep track of wheter this duck has been hit or not
        self.is_hit = False
    def draw(self):
        ...
        stick_y = self.y + self.image.get_width()
...
class BrownDuck(Duck):
    ...
    def __init__(self, x):
        ...
        #brown ducks with a target worth 4 points
    ...
    def update(self):
        ...
        #if this duck goes off screeen, add a new duck to the group
...
while running:
    ...
    #display the game over if there's no remaining bullets
